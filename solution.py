...
#Creating diag_units holding boxes in each of the 2 diagonals
diag_units = []
...
def naked_twins(values):
    ...
    #Generate all possible pairs of digits. To be compared with each box. 
        ...
        for pair in pairs:
            ...
            if len(dplaces) == 2:
                ...
                for box_temp in boxes_to_replace :
                    ...
                    values[box_temp] = ''.join(temp for temp in value if temp not in pair)
    return values
